...
Config::Config(int argc, char ** argv) : opt_cmd_("Options"), opt_cfg_("Configuration")
{
   ...
   try
   {
      ...
      try
      {
         ...
         eventinfo_     =  Form("%s/Events/%s", process_.c_str(), eventinfo_.c_str()      );
         triggerCol_    =  Form("%s/Events/%s", process_.c_str(), triggerCol_.c_str()     );
         triggerObjDir_ =  Form("%s/Events/%s", process_.c_str(), triggerObjDir_.c_str()  );
         jetsCol_       =  Form("%s/Events/%s", process_.c_str(), jetsCol_.c_str()        );
         muonsCol_      =  Form("%s/Events/%s", process_.c_str(), muonsCol_.c_str()       );
         genpartsCol_   =  Form("%s/Events/%s", process_.c_str(), genpartsCol_.c_str()    );
         genjetsCol_    =  Form("%s/Events/%s", process_.c_str(), genjetsCol_.c_str()     );
