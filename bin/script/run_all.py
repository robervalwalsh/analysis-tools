...
def condor_submit(executable, args, name, runtime=50000, memory=1000):
...
if sys.argv[1] == "bkg" and len(sys.argv) == 2:
    ...
    for params in bkg_files:
        for cl in correction_level_bkg:
            ...
            for lista, i in zip(split_list(params['filenames'], 5), range(0, 10000)):
                ...
                condor_submit(
                    ...
                    "_".join([executable, params["era"], str(i)]), 80000, 1000)
